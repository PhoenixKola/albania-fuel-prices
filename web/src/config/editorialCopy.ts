...
const en: EditorialCopy = {
  ...
  about: {
    ...
    metrics: ["Markets analysed", "Days of history", "Editorial model"],
  ...
  contact: {
    ...
    sections: [
      { id: "topics", title: "What we can help with", paragraphs: ["The inbox is intended for useful, specific conversations about the service."], bullets: ["Fuel-price or country-page corrections", "Questions about sources and methodology", "Accessibility or technical problems", "Feature ideas, practical feedback, or partnerships"] },
...
const sq: EditorialCopy = {
  ...
  about: {
    ...
    metrics: ["Tregje të analizuara", "Ditë histori", "Modeli editorial"],
  ...
  contact: {
    ...
    sections: [
      { id: "topics", title: "Për çfarë mund të ndihmojmë", paragraphs: ["Kontakti është për biseda konkrete dhe të dobishme rreth shërbimit."], bullets: ["Korrigjime çmimesh ose faqesh shteti", "Pyetje për burimet dhe metodologjinë", "Probleme aksesueshmërie ose teknike", "Ide funksionesh, komente praktike ose bashkëpunime"] },
