export const sq = {
  ...
  homeLiveStatus: "Inteligjencë tregu në kohë reale",
  ...
  homeTelemetrySource: "Burim i verifikuar",
  homeTelemetryUpdated: "Leximi i fundit",
  ...
  homeCommandKicker: "PANELI I KOMANDËS",
  homeCommandTitle: "Një treg. Çdo sinjal.",
  homeCommandSubtitle: "Zgjidh një shtet, kontrollo çdo karburant dhe lexo 30 ditët e fundit pa humbur pamjen e madhe.",
  homeRoutesKicker: "NGAS ME KONTEKST",
  homeRoutesTitle: "Tre mënyra për t'i paraprirë furnizimit tjetër.",
  homeRoutesSubtitle: "Ktheji të njëjtat të dhëna live në plan kufitar, renditje çmimesh ose ndalesën tënde të ardhshme.",
