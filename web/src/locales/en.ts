export const en = {
  ...
  homeLiveStatus: "Live market intelligence",
  ...
  homeTelemetrySource: "Verified source",
  homeTelemetryUpdated: "Latest reading",
  ...
  homeCommandKicker: "COMMAND DECK",
  homeCommandTitle: "One market. Every signal.",
  homeCommandSubtitle: "Choose a country, inspect each fuel, and read the last 30 days without losing the bigger picture.",
  homeRoutesKicker: "DRIVE WITH CONTEXT",
  homeRoutesTitle: "Three ways to get ahead of the next fill.",
  homeRoutesSubtitle: "Turn the same live dataset into a border plan, a price ranking, or your next station stop.",
