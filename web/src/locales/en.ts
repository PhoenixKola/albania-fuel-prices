export const en = {
  ...
  homeCopyFailed: "Could not copy. Please try again.",
  homeLiveStatus: "National reference snapshot",
  homeCockpitKicker: "ALBANIA / EUROPE FUEL PRICES",
  homeCockpitTitle: "Know the fuel cost before the road starts.",
  homeCockpitSubtitle:
    "Check dated national petrol, diesel and LPG reference prices, compare the road ahead, and turn the latest available reading into a practical trip estimate.",
  homeCockpitPrimaryCta: "Calculate a trip",
  ...
  homeTelemetryLabel: "Market snapshot",
  homeTelemetryMarkets: (n: number) => `${n} European markets`,
  homeTelemetryFuel: "Active fuel",
  homeTelemetrySource: "Source",
  homeTelemetryUpdated: "Prices dated",
  homeGaugePriceLabel: "Selected market price",
  homeGaugeUnavailable: "Price unavailable",
  homeGaugeRank: "Europe rank",
  homeGaugeRankValue: (rank: number, total: number) => `#${rank} of ${total}`,
  homeGaugeAverage: "vs Europe average",
  homeGaugeAverageValue: (value: string) => `${value} EUR/L`,
  homeGaugeWeek: "7-day movement",
  homeGaugeWeekFlat: "No material change",
  ...
  homeGaugeA11y: (country: string, fuel: string, price: string, rank: string, average: string, week: string) =>
    `${country}, ${fuel}. Price ${price}. Europe rank ${rank}. Difference from European average ${average}. Seven-day movement ${week}.`,
  homeCommandKicker: "FUEL PULSE",
  homeCommandTitle: "One market. Three fuel prices.",
  homeCommandSubtitle: "Choose a country, switch fuel with one tap, and see the reference price, European position, and 30-day movement as one connected reading.",
  homeRoutesKicker: "THE DRIVER'S ROUTE",
  homeRoutesTitle: "From market price to the next stop.",
  homeRoutesSubtitle: "Follow the decision path: compare borders, scan Europe, check the road, then locate fuel.",
  homeRouteCompareTitle: "Compare borders",
  homeRouteCompareText: "Put the countries on your route side by side and expose the real cost difference.",
  homeRouteRankingsTitle: "Scan Europe",
  homeRouteRankingsText: "See where your selected market sits—from the lowest pump price to the highest.",
  homeRouteStationsTitle: "Find the next stop",
  homeRouteStationsText: "Use your location to surface nearby fuel stations when the road calls for a decision.",
  homeRouteCta: "Open tool",
  homeCalculatorKicker: "ROUTE COMPUTER",
  homeCalculatorTitle: "Turn a pump price into your number.",
  homeCalculatorSubtitle: "Model a fill-up, reverse a budget, or price an entire trip with the market currently selected above.",
  homeStoryKicker: "TODAY'S MARKET STORY",
  homeStoryTitle: "The numbers, interpreted.",
  homeStorySubtitle: "A generated daily reading of the market, followed by the extremes and spreads worth knowing.",
  homeTransparencyKicker: "OPEN INSTRUMENT PANEL",
  ...
  homeTrendUnavailableText: "There are not enough recent readings to draw a reliable 30-day line for this market and fuel.",
