...
export type TDict = {
  ...
  homeCockpitKicker: string;
  homeCockpitTitle: string;
  ...
  homeTelemetrySource: string;
  homeTelemetryUpdated: string;
  homeGaugePriceLabel: string;
  homeGaugeUnavailable: string;
  homeGaugeRank: string;
  homeGaugeRankValue: (rank: number, total: number) => string;
  homeGaugeAverage: string;
  homeGaugeAverageValue: (value: string) => string;
  homeGaugeWeek: string;
  homeGaugeWeekFlat: string;
  homeGaugeWeekValue: (value: string) => string;
  homeGaugeA11y: (country: string, fuel: string, price: string, rank: string, average: string, week: string) => string;
  homeCommandKicker: string;
  homeCommandTitle: string;
  homeCommandSubtitle: string;
  homeRoutesKicker: string;
  homeRoutesTitle: string;
  homeRoutesSubtitle: string;
  homeRouteCompareTitle: string;
  homeRouteCompareText: string;
  homeRouteRankingsTitle: string;
  homeRouteRankingsText: string;
  homeRouteStationsTitle: string;
  homeRouteStationsText: string;
  homeRouteCta: string;
  homeCalculatorKicker: string;
  homeCalculatorTitle: string;
  homeCalculatorSubtitle: string;
  homeStoryKicker: string;
  homeStoryTitle: string;
  homeStorySubtitle: string;
  homeTransparencyKicker: string;
