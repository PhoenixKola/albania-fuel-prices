export default function JourneyArtwork() {
  return <svg className="journeyArtwork" viewBox="0 0 340 300" fill="none" aria-hidden="true">
    <defs>
      <linearGradient id="journey-road" x1="60" y1="280" x2="280" y2="20" gradientUnits="userSpaceOnUse"><stop stopColor="#63EDBD" /><stop offset="1" stopColor="#BFFFE3" /></linearGradient>
    ...
    <path d="M48 258C94 258 124 238 121 207C118 176 68 178 79 136C90 94 239 153 255 105C271 57 216 57 234 31" stroke="#082E25" strokeWidth="30" strokeLinecap="round" />
    ...
    <circle cx="48" cy="258" r="17" fill="#61EFBD" fillOpacity=".12" /><circle cx="48" cy="258" r="7" fill="#61EFBD" />
    <circle cx="234" cy="31" r="17" fill="#61EFBD" fillOpacity=".12" /><circle cx="234" cy="31" r="7" fill="#61EFBD" />
    <g transform="translate(141 141)"><rect x="-24" y="-24" width="48" height="48" rx="14" fill="#E9FFF6" /><path d="M-8 9V-10H4V9M-11 9H7M-8-3H4M4-8H8L12-3V6C12 10 8 10 8 6V2H4" stroke="#0A5B42" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round" /></g>
