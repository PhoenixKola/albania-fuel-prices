...
The rental referral path is independent from display advertising. A traveler estimating a road-trip budget is a relevant prospective rental customer. That is a product hypothesis to measure, not a promise of conversions. The [DiscoverCars program](https://www.discovercars.com/affiliate) advertises around $20 average commission; actual completed rentals and account terms determine payment.
...
| --- | --- | --- |
| DiscoverCars affiliate referrals | First priority; already integrated | Maintain payout details and genuine tracking URLs. Income depends on eligible completed rentals. |
...
Adsterra Native Banner is now integrated behind explicit visitor consent and `VITE_ADSTERRA_ENABLED`; it remains disabled for the infrastructure deployment. Run a limited placement trial and decide using observed revenue per 1,000 visits, engagement, page performance and actual ad quality. Avoid formats that obstruct calculator controls or open unexpected windows.
...
## Decommissioned AdSense context

Google AdSense runtime support was removed after repeated low-value-content rejections. The Albanian interface is public again. Historical rejection context does not affect the active DiscoverCars, Cloudflare Web Analytics, or consent-gated Adsterra integrations.
